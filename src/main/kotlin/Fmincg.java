...
import ru.ifmo.ctddev.isaev.data.CostGradientTuple;
import ru.ifmo.ctddev.isaev.data.DoubleVector;
...
public final class Fmincg {
    ...
    public static DoubleVector minimizeFunction(Function<DoubleVector, CostGradientTuple> f,
                                                DoubleVector theta, int maxIterations, boolean verbose) {
        return new Fmincg().minimize(f, theta, maxIterations, verbose);
    }

    public final DoubleVector minimize(Function<DoubleVector, CostGradientTuple> f, DoubleVector theta,
        ...
        final CostGradientTuple evaluateCost = f.apply(input);
        ...
        while (i < Math.abs(length)) {// while not finished
            ...
            final CostGradientTuple evaluateCost2 = f.apply(input);
            ...
            while (true) {
                while (((f2 > f1 + z1 * RHO * d1) | (d2 > -SIG * d1)) && (M > 0)) {
                    ...
                    final CostGradientTuple evaluateCost3 = f.apply(input);
